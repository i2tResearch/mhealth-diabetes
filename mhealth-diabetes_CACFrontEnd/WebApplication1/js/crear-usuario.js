...
//var url = 'http://0.0.0.0:0000/api/cac/v1/user/';
        ...
        firebase.auth().createUserWithEmailAndPassword(email, password).then(function (user) {
            ...
            .done(function (response) {
                ...
                if (response === 'true') { 
                    ...
                    mostrarMensaje('No se pudo crear el usuario', 4000);
                }
            })
            .fail(function (response) {
                mostrarMensaje('No se pudo crear el usuario', 4000);
            ...
            mostrarMensaje(errorCode + ' - ' + errorMessage, 4000);
        });
