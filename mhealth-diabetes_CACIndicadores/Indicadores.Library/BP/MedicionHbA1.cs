...
{
    public class MedicionHbA1 : CalculoIndicadoresProceso
    {
        ...
        public override Resultado callProcedure(DateTime fechaInicio, String idOrganizacion)
        {
            ...
            return ConexionProcAlmacenados.GetInstance().ObtenerDatosIndicadores(ConstantesPrcs.PRC_MEDICION_HBA1C, parametros);
        }
