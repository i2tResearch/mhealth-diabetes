...
{
    public class MedicionTiempoCreatinina : CalculoIndicadoresProceso
    {
        public override Resultado callProcedure(DateTime fechaInicio, String idOrganizacion)
        {
            ...
            return ConexionProcAlmacenados.GetInstance().ObtenerDatosIndicadores(ConstantesPrcs.PRC_MEDICION_CREATININA, parametros);
        }
    }
}
